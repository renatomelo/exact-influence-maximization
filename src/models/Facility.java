...
public class Facility {
	...
	public static void main(String[] args) {
		try {
			...
			double FixedCosts[] = new double[] { 12000, 15000, 17000, 13000, 16000 };
...
*/
			...
			System.out.print("\nx variables: ");
			for (int p = 0; p < nPlants; ++p)
				System.out.print(open[p].get(GRB.DoubleAttr.X) + " ");
			
			System.out.println("\n\ny (trasnport) variables:");
			for (int p = 0; p < nPlants; ++p) {
				for (int w = 0; w < nWarehouses; ++w) {
					System.out.print(transport[w][p].get(GRB.DoubleAttr.X) + "\t");
				}
				System.out.println();
			}
